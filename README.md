...
Апробация 
Применить алгоритм на примере сравнения профилей экспрессии Арабидопсиса и Кукурузы. Количество генов Арабидобсиса 39005. Количество генов курурузы 33322. Размер профилей экспрессии Арабидопсиса - 2193, Кукурузы - 1774.   
...
Кроме этого в синтаксисе micans.org было написано:
1) Задача трансформации файла попарной комбинации всех генов в матрицу соответсвий.
2) Задача кластеризация, подбор параметров, когда это нужно #knn, #ceilnb, -I, -Pi, -tf 'gq(0.7),add(-0.7)',-tf 'ceil(0.55)'  и.т.д. 
