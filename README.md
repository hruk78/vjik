...
два примерно равных кластера, один - кукурузы, другой - альбидопсиса и от 324 до 5 000 синглетонов. По-видимому scale_pos_weight=84 был ошибкой. Он вычислялся из соображений, что суммарная отрицательная выборка по всем 101 иттерациям в 84 раза больше количества отропар. Однако если оценивать это соотношение в пределах одной иттерации, то она чуть больше еденицы. В результате надо строить новую модель с другими параметрами, scale_pos_weight=2, max_depth=7, кол-во итераций пусть будет 75,
