...
1) Linux 2.6.32-573.12.1.el6.x86_64 - основная, до 80 ядер, до 2 ТB оперативной памяти, дисковое пространство ~5 Tb.
2) CYGWIN_NT-6.3 geronimo 3.1.0(0.340/5/3) 2019-12-10 23:47 x86_64 Cygwin - тестовая система 4 ядра, 30 Гб оперативки и 1 Тб SSD жесткий диск.
...
На системе типа (1) весь цикл начиная с тренировки и заканчивая кластеризацие занимает 1 неделю.
